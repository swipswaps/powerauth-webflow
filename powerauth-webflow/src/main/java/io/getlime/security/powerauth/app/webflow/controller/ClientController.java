...
public class ClientController {
    ...
    @Autowired
    public ClientController(HttpServletRequest httpServletRequest, HttpSession httpSession) {
        this.httpServletRequest = httpServletRequest;
        this.httpSession = httpSession;
    }

    @RequestMapping(value = "verify-tls", method = { RequestMethod.GET, RequestMethod.POST })
